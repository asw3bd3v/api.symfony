 ...
 */
final class Version20240723131043 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book_content (id INT NOT NULL, chapter_id INT NOT NULL, content TEXT DEFAULT NULL, is_published BOOLEAN DEFAULT false NOT NULL, PRIMARY KEY(id))');
