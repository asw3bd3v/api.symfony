 ...
 */
final class Version20240722125055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book_chapter (id INT NOT NULL, parent_id INT DEFAULT NULL, book_id INT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, sort INT DEFAULT 0 NOT NULL, level INT NOT NULL, PRIMARY KEY(id))');
